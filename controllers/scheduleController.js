...
module.exports.createSchedule = (req, res) => {
    const{schedule_Name, schedule_Description, schedule_StartDate, schedule_EndDate, user_id,vehicle_id,shop_id} = req.body;

    const query = `Insert into schedule (schedule_Name, schedule_Description, schedule_StartDate, schedule_EndDate, user_id, vehicle_id, shop_id) values (?, ?, ?, ?, ?, ?, ?)`;
    const values = [schedule_Name, schedule_Description, schedule_StartDate, schedule_EndDate, user_id, vehicle_id, shop_id];
...
module.exports.readSchedule = (req, res) =>{
    const{schedule_id, schedule_Name, schedule_Description, schedule_StartDate, schedule_EndDate, user_id,vehicle_id,shop_id} = req.body;

    const query =`Select *  from schedule`;
    const values = [schedule_id, schedule_Name, schedule_Description, schedule_StartDate, schedule_EndDate, user_id,vehicle_id,shop_id];
